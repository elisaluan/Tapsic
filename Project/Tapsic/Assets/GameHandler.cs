...
public class GameHandler : MonoBehaviour {
    ...
    void Update() {
        ...
        {  /// encompass everything
            //print("enter");
            if (Equals((string)buttonColour[indexPosition], "E"))
            {
                curr_time = time_now;
            ...
            else if (Equals((string)buttonColour[indexPosition], "Q"))
            {
                curr_time = time_now;
...
/* -- Commented out to allow for computer only use
    ...
    bool CheckButtonPress()
    {
        if (curr_button < latest_button)
        {
            try
            {
                ...
                if ((Input.GetKeyDown(KeyCode.Q) && string.Equals((string)buttonColour[curr_button], "Q")) ||
                     (Input.GetKeyDown(KeyCode.W) && string.Equals((string)buttonColour[curr_button], "W")) ||
                     (Input.GetKeyDown(KeyCode.E) && string.Equals((string)buttonColour[curr_button], "E")))
                {
